...
class MobileDevice(Document):
    ...
    imei_device = StringField(required=False, blank=True, null=True)
    number_phone = IntField(required=False, blank=True, null=True)
    message = StringField(required=False, blank=True, null=True)
    date_creation = DateTimeField(required=False, default=datetime.datetime.now)
    fire_percentage = StringField(required=False, blank=True, null=True)
